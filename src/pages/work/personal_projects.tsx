    ...
    <Article title='Personal Projects'>
      <Container>
        ...
        <UnorderedList my={4}>
          ...
          <ListItem>Leo Weather - This is one of the first React Native apps I built.</ListItem>
        ...
        and they also made it harder for solo developers to upload.
        ...
        <SimpleGrid justifyItems='center' columns={[1, 1, 2]} gap={1}>
          <Flex
            ...
            <Flex
              ...
              />
              <Flex justifyContent='space-between' width='320px' mt='15px'>
                <Link href='https://apps.apple.com/us/app/leo-weather/id1602629978' rel="noopener noreferrer" target='_blank'>
                  <Image
                    width={150}
                    height={60}
                    src='/photos/app_store.png'
              ...
              <Link mt='10px' href='https://github.com/leorod90/leo-weather' rel="noopener noreferrer" target='_blank'>
                <Image
                  width={150}
                  height={60}
                  src='/photos/github.png'
          ...
          <SimpleGrid justifyItems='center' columns={[1, 2, 2]} gap={1} order={[2, 2, 1]}>
            ...
            <ProjectVideoPlayer src={require('../../../public/mp4/weather_1.mp4')} />
            <ProjectVideoPlayer src={require('../../../public/mp4/weather_2.mp4')} />
            {/* </Flex> */}
          </SimpleGrid>
        </SimpleGrid>
